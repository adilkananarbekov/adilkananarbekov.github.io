export const enPortfolio = {
  locale: "en-US",
  meta: {
    title: "Adilkan Anarbekov | Mobile Apps, UI and Motion-Driven Presentation",
    description:
      "Portfolio of Adilkan Anarbekov: mobile app development, interface redesign, motion-driven presentation and digital products for business."
  },
  ui: {
  ...
  hero: {
    ...
    consoleFooter: "Ready for new projects",
    consoleLines: [
      {
        label: "focus",
        text: "Clear mobile solutions and presentation websites for real business needs."
      },
      {
        label: "motion",
        text: "From quiet reveal systems to more cinematic hero scenes and scroll pacing."
      },
      {
        label: "delivery",
        text: "Clear communication, polished design and a predictable project rhythm."
      },
      {
        label: "status",
        text: "Available for freelance work, collaborations and visually ambitious client work."
      }
    ]
  },
  motion: {
  ...
  experience: {
    ...
    pressCta: "Activate preview",
    pressResult: "Live mode armed",
    modes: [
      {
        label: "Reveal",
  ...
  services: {
    ...
    items: [
      ...
      {
        icon: "document",
        title: "Creative digital presentation",
        description:
  ...
  process: {
    ...
    stats: [
      {
        label: "Focus",
        value: "Mobile products and creative presentation"
      },
      {
        label: "Communication",
        value: "Clear updates at every stage"
      },
      {
        label: "Location",
  ...
  footer:
    "Adilkan Anarbekov. Mobile apps, interface redesign and creative digital presentation.",
  footerBlock: {
